...
import '../shared/printer_manager.dart';
...
class _PrintersViewState extends State<PrintersView> {
  ...
  Future<void> _initImg() async {
    try {
      // Get the application documents directory
      final directory = await getApplicationDocumentsDirectory();
      String imagePath = '${directory.path}/receipt.png'; // Same path as saved
      imgFile = File(imagePath);

      if (await imgFile.exists()) {
        print("Image found at: $imagePath");
      } else {
